    ...
    <div className="container">
      { (cartList.length === 0) ?
        ...
        <div>
          ...
          { id ? 
            <div>
            <h3 className="d-flex justify-content-end"> {`Monto total de la compra : ${totalPrice().toLocaleString("es-CL")} Pesos`}</h3>
            <Link to = '/'>
            ...
            :
            <div>
              <h3 className="d-flex justify-content-center"> {`Monto total de la compra : ${totalPrice().toLocaleString("es-CL")} Pesos`}</h3>
